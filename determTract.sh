...
MNI=/data/jux/daviska/apines/atlases/MNI152_T1_2mm_brain.nii.gz
AAL=/data/jux/daviska/apines/atlases/merged.nii.gz
Apath=/data/jux/daviska/apines/atlases
...
#antsApplyTransforms -d 3 -e 0 -i ${Apath}/RHip.nii.gz -r /data/jux/daviska/apines/3T_Subjects_NODDI/${IDs}/coreg/${IDs}_DWISpaceT1.nii.gz -o  $out/coreg/${IDs}_HO_RHip.nii.gz -t /data/jux/daviska/apines/3T_Subjects_NODDI/${IDs}/coreg/${IDs}_MNI_T1_Warp1Warp.nii.gz -t  $out/coreg/${IDs}_MNI_T1_Warp0GenericAffine.mat -n NearestNeighbor

#antsApplyTransforms -d 3 -e 0 -i ${Apath}/LHip.nii.gz -r /data/jux/daviska/apines/3T_Subjects_NODDI/${IDs}/coreg/${IDs}_DWISpaceT1.nii.gz -o  $out/coreg/${IDs}_HO_LHip.nii.gz -t /data/jux/daviska/apines/3T_Subjects_NODDI/${IDs}/coreg/${IDs}_MNI_T1_Warp1Warp.nii.gz -t  $out/coreg/${IDs}_MNI_T1_Warp0GenericAffine.mat -n NearestNeighbor

#antsApplyTransforms -d 3 -e 0 -i ${Apath}/RightThal.nii.gz -r /data/jux/daviska/apines/3T_Subjects_NODDI/${IDs}/coreg/${IDs}_DWISpaceT1.nii.gz -o  $out/coreg/${IDs}_HO_RThal.nii.gz -t /data/jux/daviska/apines/3T_Subjects_NODDI/${IDs}/coreg/${IDs}_MNI_T1_Warp1Warp.nii.gz -t  $out/coreg/${IDs}_MNI_T1_Warp0GenericAffine.mat -n NearestNeighbor

#antsApplyTransforms -d 3 -e 0 -i ${Apath}/HO_Prec_AngG_Thal.nii.gz -r /data/jux/daviska/apines/3T_Subjects_NODDI/${IDs}/coreg/${IDs}_DWISpaceT1.nii.gz -o  $out/coreg/${IDs}_HO_Prec_AngG.nii.gz -t /data/jux/daviska/apines/3T_Subjects_NODDI/${IDs}/coreg/${IDs}_MNI_T1_Warp1Warp.nii.gz -t  $out/coreg/${IDs}_MNI_T1_Warp0GenericAffine.mat -n NearestNeighbor
...
fslmaths ${out}/coreg/${IDs}_HO_LThal.nii.gz -add ${out}/coreg/${IDs}_HO_RThal.nii.gz ${out}/coreg/Thals
fslmaths ${out}/coreg/Thals.nii.gz -add ${out}/coreg/${IDs}_HO_RHip.nii.gz ${out}/coreg/ThalsRH
fslmaths ${out}/coreg/ThalsRH.nii.gz -add ${out}/coreg/${IDs}_HO_LHip.nii.gz ${out}/coreg/ThalsHips
fslmaths ${out}/coreg/ThalsHips.nii.gz -add ${out}/coreg/${IDs}_HO_Prec_AngG.nii.gz ${out}/coreg/${IDs}_HO_Ang_Prec_Thals_Hips
...
seed_path=$out/coreg/${IDs}_HO_Ang_Prec_Thals_Hips.nii.gz
atlas_path=$out/coreg/${IDs}_HO_Ang_Prec_Thals_Hips.nii.gz
...
##fslmaths $out/coreg/${IDs}_HO_RHip.nii.gz -add $out/coreg/${IDs}_HO_LHip.nii.gz $out/coreg/${IDs}_HO_Hips
##fslmaths $out/coreg/${IDs}_HO_Hips.nii.gz -add $out/coreg/${IDs}_HO_Precun.nii.gz ${out}/coreg/${IDs}_Precun_Hips
##fslmaths ${out}/coreg/int.nii.gz -add $out/coreg/${IDs}_HO_RThal.nii.gz ${out}/tractography/HippoThalHO.nii.gz
...
tractography_output=$out/tractography/${IDs}_HO_Precun_AngG_HipsThal.Bdouble


#Camino tractography
${cdir}/dtlutgen -schemefile $out/tractography/${IDs}.scheme -snr 25 > ${out}/picotable.dat

cat $out/tractography/${IDs}_WdtModelFit.Bdouble | ${cdir}/picopdfs -inputmodel dt -luts ${out}/picotable.dat | ${cdir}/track -inputmodel pico -seedfile $out/coreg/${IDs}_HO_Ang_Prec_Thals_Hips.nii.gz -iterations 1000 -curvethresh 80 -anisthresh 0.03 -anisfile ${out}/tractography/${IDs}_Camino_FA.nii.gz | $cdir/procstreamlines -exclusionfile ${exclusion_path} -truncateinexclusion -endpointfile $out/coreg/${IDs}_HO_Ang_Prec_Thals_Hips.nii.gz -outputfile ${tractography_output}
...
/data/jux/daviska/apines/camino-trackvis-0.2.8.1/bin/camino_to_trackvis -i ${tractography_output} -o ${out}/tractography/${IDs}_Precun_AngG_Hips_streamlines.trk --nifti $out/prestats/${IDs}_eddied_undistort_warped_t1Masked.nii.gz --phys-coords
...
# Mean ICVF matrix
$cdir/conmat -inputfile "${tractography_output}" -targetfile ${seed_path} -scalarfile $out/coreg/FIT_ICVF.nii -tractstat mean -outputroot $out/tractography/${IDs}_ICVF_HO_Precun_AngGHipsThal

# Mean ODI matrix
$cdir/conmat -inputfile "${tractography_output}" -targetfile ${seed_path} -scalarfile $out/coreg/FIT_OD.nii -tractstat mean -outputroot $out/tractography/${IDs}_ODI_HO_Precun_AngGHipsThal

# Mean FA matrix
#shady step to make FA and AAL equivalent
fslcpgeom ${seed_path} $out/tractography/${IDs}_Camino_FA.nii.gz

$cdir/conmat -inputfile "${tractography_output}" -targetfile ${seed_path} -scalarfile $out/tractography/${IDs}_Camino_FA.nii.gz -tractstat mean -outputroot $out/tractography/${IDs}_FA_HO_Precun_AngGHipsThal
